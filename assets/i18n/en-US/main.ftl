...
settings-starry = Starry stage
settings-starry-detail = Halo the fullscreen cover with drifting particles and a spectrum ring that follows the visualizer
settings-vinyl = Spinning vinyl
settings-vinyl-detail = Dress the cover as the label of a record that turns under a slow sheen
