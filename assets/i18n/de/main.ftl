...
settings-blur = Verwischen
settings-blur-detail = Das Fenster wird über einen verschwommenen Schreibtisch Hintergrund gezeichnet. Benötigt eine Deckkraft unter 100 %.
settings-discord = Auf Discord anzeigen
settings-discord-detail = Den gerade laufenden Titel im Discord Profil anzeigen
settings-discord-name = Statusname
settings-discord-name-detail = Wie der Status zwischen dem "Hört ... zu" heißt den deine Freunde sehen
settings-discord-name-sonora = Sonora
settings-discord-name-provider = Anbieter
settings-discord-name-music = Musik
settings-discord-name-title = Titel
settings-discord-name-artist = Künstler
settings-discord-name-artist-title = Künstler - Titel
settings-discord-show-paused = Bei Pause anzeigen
settings-discord-show-paused-detail = Behält den Status im Discord Profil, während der Titel pausiert ist
settings-discord-badge = Symbol des Anbieters anzeigen
settings-discord-badge-detail = Markiert den Status mit einem kleinen Symbol des Anbieters, von welchem der Titel kommt
settings-discord-anonymous = Details verbergen
settings-discord-anonymous-detail = Zeigt nur, dass Musik läuft – ohne Titel, Künstler oder Cover
# the Discord status when the track is left out of it
discord-listening = Hört Musik
settings-sleep = Schlaf-Timer
settings-sleep-detail = Lässt die Musik nach einer festgelegten Zeit von selbst aufhören, damit du sie zum Schlaf spielen kannst
settings-sleep-configure = Konfigurieren…
settings-sleep-off = Aus
settings-sleep-end-of-track = Am Ende des Titels
settings-sleep-minutes = { $count } Min.
settings-equalizer = Equalizer
settings-equalizer-detail = Formt den Klang über zehn Frequenzbänder, eines pro Oktave
settings-equalizer-preset = Voreinstellung
settings-equalizer-preset-detail = Eine fertige Kurve für die Bänder unten
settings-equalizer-custom = Benutzerdefiniert
settings-equalizer-flat = Neutral
settings-equalizer-bass-boost = Bassverstärkung
settings-equalizer-bass-reducer = Bassreduzierer
settings-equalizer-treble-boost = Höhenverstärkung
settings-equalizer-vocal = Gesang
settings-equalizer-rock = Rock
settings-equalizer-pop = Pop
settings-equalizer-jazz = Jazz
